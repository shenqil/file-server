...
// 定义全局上下文中的数据
type (
	transCtx     struct{} // 事务上下文
	noTransCtx   struct{} // 不使用事务上下文
	transLockCtx struct{} // 事务锁上下文
	userIDCtx    struct{} // 用户ID上下文
	traceIDCtx   struct{} // 跟踪ID上下文
)
